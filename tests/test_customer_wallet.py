...
class TestCustomerWallet:
    ...
    def test_deposit_success(self, client, customer_headers, customer_user):
        ...
        response = client.post(
            "/api/v1/customer/wallet/deposit",
        ...
        assert response.json["wallet"]["balance"] == 100500000.00
    ...
    def test_deposit_missing_amount(self, client, customer_headers):
        ...
        response = client.post(
            "/api/v1/customer/wallet/deposit", headers=customer_headers, json={}
        )
    ...
    def test_get_transactions_success(self, client, customer_headers):
        ...
        response = client.get(
            "/api/v1/customer/wallet/transactions", headers=customer_headers
        )
    ...
    def test_get_transactions_pagination(self, client, customer_headers):
        ...
        response = client.get(
            "/api/v1/customer/wallet/transactions?page=1&per_page=5",
            headers=customer_headers,
        )
