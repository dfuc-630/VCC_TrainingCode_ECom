...
class TestAdminUsers:
    ...
    def test_get_users_filter_by_role(self, client, admin_headers, customer_user, seller_user):
    ...
    def test_get_user_detail_success(self, client, admin_headers, customer_user):
        ...
        response = client.get(f'/api/admin/users/{customer_user.id}',
                            headers=admin_headers)
...
class TestAdminProducts:
    ...
    def test_get_products_filter_by_seller(self, client, admin_headers, product, seller_user):
        """Test get products filtered by seller"""
        response = client.get(f'/api/admin/products?seller_id={seller_user.id}',
                            headers=admin_headers)
    ...
    def test_get_product_detail_success(self, client, admin_headers, product):
        ...
        response = client.get(f'/api/admin/products/{product.id}',
                            headers=admin_headers)
...
class TestAdminOrders:
    ...
    def test_get_order_detail_success(self, client, admin_headers, customer_headers, product):
...
class TestAdminDashboard:
    ...
    def test_get_dashboard_success(self, client, admin_headers, customer_user, seller_user, product):
