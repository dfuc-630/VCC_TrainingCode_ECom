...
class TestCustomerProducts:
    ...
    def test_search_products_success(self, client, customer_headers, product):
        ...
        response = client.get("/api/v1/customer/products", headers=customer_headers)
    ...
    def test_search_products_by_name(self, client, customer_headers, product):
        ...
        response = client.get(
            "/api/v1/customer/products?search=iPhone", headers=customer_headers
        )
    ...
    def test_search_products_no_results(self, client, customer_headers, product):
        ...
        response = client.get(
            "/api/v1/customer/products?search=Samsung", headers=customer_headers
        )
    ...
    def test_search_products_by_category(
        self, client, customer_headers, product, category
    ):
        """Test search products by category"""
        response = client.get(
            f"/api/v1/customer/products?category_id={category.id}",
    ...
    def test_search_products_pagination(self, client, customer_headers, product):
        ...
        response = client.get(
            "/api/v1/customer/products?page=1&per_page=10", headers=customer_headers
        )
    ...
    def test_get_product_detail_success(self, client, customer_headers, product):
        ...
        response = client.get(
            f"/api/v1/customer/products/{product.id}", headers=customer_headers
        )
    ...
    def test_get_product_not_found(self, client, customer_headers):
        ...
        response = client.get(
            "/api/v1/customer/products/invalid-id", headers=customer_headers
        )
