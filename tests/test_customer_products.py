...
class TestCustomerProducts:
    ...
    def test_search_products_by_name(self, client, customer_headers, product):
        ...
        response = client.get(
            "/api/customer/products?search=iPhone", headers=customer_headers
        )
    ...
    def test_search_products_no_results(self, client, customer_headers, product):
        ...
        response = client.get(
            "/api/customer/products?search=Samsung", headers=customer_headers
        )
    ...
    def test_search_products_by_category(
        ...
        response = client.get(
            f"/api/customer/products?category_id={category.id}",
    ...
    def test_search_products_pagination(self, client, customer_headers, product):
        ...
        response = client.get(
            "/api/customer/products?page=1&per_page=10", headers=customer_headers
        )
    ...
    def test_get_product_detail_success(self, client, customer_headers, product):
        ...
        response = client.get(
            f"/api/customer/products/{product.id}", headers=customer_headers
        )
    ...
    def test_get_product_not_found(self, client, customer_headers):
        ...
        response = client.get(
            "/api/customer/products/invalid-id", headers=customer_headers
        )
