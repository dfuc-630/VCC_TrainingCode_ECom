...
Revision ID: 631233521f1f
Revises: 8e19f6d47ba9
Create Date: 2026-02-06 10:53:00.496185
...
revision = '631233521f1f'
down_revision = '8e19f6d47ba9'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('PENDING', 'PROCESSING', 'CONFIRMED', 'SHIPPING', 'COMPLETED', 'CANCELLED', name='order_statuses'), nullable=True),
