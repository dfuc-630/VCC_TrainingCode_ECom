...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("CUSTOMER", "SELLER", "ADMIN", name="user_roles"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_status",
            sa.Enum("UNPAID", "PAID", "REFUNDED", name="payment_statuses"),
            nullable=True,
        ),
    ...
    with op.batch_alter_table("orders", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_orders_order_number"), ["order_number"], unique=True
        )
        batch_op.create_index(
            batch_op.f("ix_orders_seller_id"), ["seller_id"], unique=False
        )
    ...
    with op.batch_alter_table("products", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_products_seller_id"), ["seller_id"], unique=False
        )
    ...
    with op.batch_alter_table("order_items", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_order_items_order_id"), ["order_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_order_items_product_id"), ["product_id"], unique=False
        )
    ...
    with op.batch_alter_table("wallet_transactions", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_wallet_transactions_order_id"), ["order_id"], unique=False
        )
        batch_op.create_index(
